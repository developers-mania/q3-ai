...
**Session 03 moved citation from 17% to 33% and retrieval down 5 points.** The drop is
a single question — q14, on the AI Strategy, which is chunked flat because that
document has no structure to be aware of. One question on twenty is 5%, and it is
worth more as a recorded oddity than as a rounding error nobody explained.
